...
const TABS = [
  { label: "Overtime Summary",          endpoint: "/overtime/summary"                },
  { label: "Extra Hours",               endpoint: "/overtime/extra-hours"            },
  { label: "Overtime vs Extra Hours",   endpoint: "/overtime/overtime-vs-extra-hours"},
  { label: "Mileage Report",            endpoint: "/overtime/total-mileage-by-employee"},
  { label: "Fuel Report",               endpoint: "/overtime/fuel-summary"           },
];
